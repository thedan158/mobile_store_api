...
import { getAllProducts, getAdminProducts, createProduct, updateProduct, deleteProducts, getProductDetails, createProductReview, getProductReviews, deleteReview, getAdminCategory, createAdminCategory } from "../controllers/productController.js";


router.route("/products").get(getAllProducts);
router.route("/admin/products").get(isAuthenticatedUser, authorieRoles("admin"), getAdminProducts);
router.route("/admin/categories").get(isAuthenticatedUser, getAdminCategory);

router.route("/product/:id").get(getProductDetails);


router.route("/admin/product/new").post(isAuthenticatedUser, authorieRoles("admin"), createProduct);
router.route("/admin/category/new").post(isAuthenticatedUser, authorieRoles("admin"), createAdminCategory);
